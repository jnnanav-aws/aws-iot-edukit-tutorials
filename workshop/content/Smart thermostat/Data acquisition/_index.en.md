...
Issue the following commands to read from the temperature sensor module (MPU6886):
...
Issue the following command to continuously collect temperature readings every 1,000 milliseconds:
...
Next, you will utilize local Wi-Fi and AWS endpoint configuration that you established during the [CloudConnected Blinky](en/blinky-hello-world.html) tutorial. Complete the following steps to compile copy the configuration from the Blinky project, compile the device firmware, and upload it to your device. (Use the directions that correspond to your host machine's operating system): 
